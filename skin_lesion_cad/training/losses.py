""" 
Taken from https://github.com/yaopengUSTC/mbit-skin-cancer/blob/main/lib/loss/loss.py

and based on

Peng Yao, Shuwei Shen, Mengjuan Xu, Peng Liu, Fan Zhang, Jinyu Xing, Pengfei Shao,
Benjamin Kaffenberger, & Ronald X. Xu (2022). Single Model Deep Learning on Imbalanced
Small Datasets for Skin Lesion Classification. IEEE Transactions on Medical Imaging,41(5), 1242–1254.
"""
import torch
